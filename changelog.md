...
However the code change (for that) was trivial, as noted below.

This version also bumps the script up from bare POSIX (with existing bashisms as a bug), to Bash v3.2+ - which covers all Linux, BSD with bash installed, and MacOS's outdated GPLv2 bash.
